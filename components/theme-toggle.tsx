...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="inline-flex size-11 cursor-pointer items-center justify-center rounded-xl text-[var(--navy)] transition hover:bg-[var(--control-hover)] focus-visible:outline-none sm:size-10 sm:rounded-lg"
    >
